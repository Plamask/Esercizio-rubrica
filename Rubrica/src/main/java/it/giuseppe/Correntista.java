...
public class Correntista extends Utente {
	...
	public Correntista caricamentoCorrentista (ArrayList<Correntista> correntista) {
		...
		int flag = 0;
			...
			System.out.println("Vuoi associare un conto? Premi 1");
			flag = Integer.parseInt(input.nextLine());
			System.out.println("Quanti ne vuoi associare?");
			numConti = Integer.parseInt(input.nextLine());
...
public void Prelievo (ArrayList<Correntista> correntista) {
	...
	if(trovato==1) {
		...
		System.out.println("Ciao"+ " " + nome + " " + cognome + " " + "Quanto vuoi prelevare?");
